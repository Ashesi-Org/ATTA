...
// get user id of last added user
$user_id = $_GET['user_id'];

if (is_learning_style_set($user_id))
{
    header("Location: index.php");
}
//  Get course pretest questions
$pretest_questions = get_LS_pretest();
        ...
        <div class="card card-form">
            <div class="row no-gutters">
                <div class="col-lg-4 card-body">
                    <p><strong class="headings-color">Learning Style Pre-Test</strong></p>
                    <p class="text">We want to determine your learning style.</p>
                </div>
                <div class="col-lg-8 card-form__body card-body">
                    <form id="pretestForm" action="Actions/learning-style.php" method="POST">
                        <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
                        <input type="hidden" name="course_id" value="<?php echo $course_id; ?>">
                        <?php if (isset($pretest_questions) && is_array($pretest_questions)) : ?>
                            <?php foreach ($pretest_questions as $index => $q) : ?>
                                <input type="hidden" name="question-<?php echo $index; ?>" value="<?php echo htmlspecialchars($q['question_text']); ?>">
                                <input type="hidden" name="answer-<?php echo $index+1; ?>" value="<?php echo $index + 1; ?>">
                                <?php if (is_array($q) && isset($q['question_text'])) : ?>
                                    <div class="card question-card" id="question-<?php echo $index; ?>" style="<?php echo $index === 0 ? '' : 'display: none;'; ?>; min-height: 400px; width: 650px">
                                        ...
                                        <div class="card-body">
                                            ...
                                            $answers = get_pretest_answers($index + 1);
                                            ?>
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input id="customRadio-<?php echo $index; ?>-1" name="answer-<?php echo $index+1; ?>" type="radio" class="custom-control-input" value="<?php echo $answers[0]['answer_text']; ?>">
                                                    <label for="customRadio-<?php echo $index; ?>-1" class="custom-control-label"><?php echo $answers[0]['answer_text']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input id="customRadio-<?php echo $index; ?>-2" name="answer-<?php echo $index+1; ?>" type="radio" class="custom-control-input" value="<?php echo $answers[1]['answer_text']; ?>">
                                                    <label for="customRadio-<?php echo $index; ?>-2" class="custom-control-label"><?php echo $answers[1]['answer_text']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input id="customRadio-<?php echo $index; ?>-3" name="answer-<?php echo $index+1; ?>" type="radio" class="custom-control-input" value="<?php echo $answers[2]['answer_text']; ?>">
                                                    <label for="customRadio-<?php echo $index; ?>-3" class="custom-control-label"><?php echo $answers[2]['answer_text']; ?></label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="custom-control custom-radio">
                                                    <input id="customRadio-<?php echo $index; ?>-4" name="answer-<?php echo $index+1; ?>" type="radio" class="custom-control-input" value="<?php echo $answers[3]['answer_text']; ?>">
                                                    <label for="customRadio-<?php echo $index; ?>-4" class="custom-control-label"><?php echo $answers[3]['answer_text']; ?></label>
                                                </div>
                                            </div>
                                        </div>
