            ...
            <div class="container-fluid pr-0 ">
                ...
                <div class="d-flex sidebar-account flex-shrink-0 mr-auto mr-lg-0">
                    <a href="index.php" class="flex d-flex align-items-center text-underline-0">
                        ...
                        <span class="flex d-flex flex-column text-white">
                            <strong class="sidebar-brand">ATTA</strong>
                        </span>
                    </a>
                </div>
                ...
                <div class="dropdown">
                    <a href="#account_menu" class="dropdown-toggle navbar-toggler navbar-toggler-dashboard border-left d-flex align-items-center ml-navbar" data-toggle="dropdown">
                        <span class="ml-1 d-flex-inline">
                            <span class="text-light">
                                <?php if (logged_in() == 1) :
                                    echo get_user_details($_SESSION['user_id'])['first_name'];
                                endif;
                    ...
                    <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                        ...
                        <a class="dropdown-item d-flex align-items-center py-2" href="edit-account.php">
                        ...
                        <a class="dropdown-item d-flex align-items-center py-2" href="Actions/logout_user.php">
