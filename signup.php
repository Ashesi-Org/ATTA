...
<body class="layout-login-centered-boxed">
    <div class="layout-login-centered-boxed__form">
        ...
        <div class="card card-body">
            ...
            <form id="signupForm" action="Actions/register_user.php" method="POST" novalidate>
                <div class="form-group">
                    <label class="text-label" for="email_2">First Name:</label>
                    <div class="input-group input-group-merge">
                        <input id="fname" type="text" name="fname" required="" class="form-control form-control-prepended" placeholder="john">
                ...
                <div class="form-group">
                    <label class="text-label" for="email_2">Last Name:</label>
                    <div class="input-group input-group-merge">
                        <input id="lname" type="text" name="lname" required="" class="form-control form-control-prepended" placeholder="doe">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <span class="far fa-user"></span>
                            </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-merge">
                        <input id="confirm_password" type="password" name="confirm_password" required="" class="form-control form-control-prepended" placeholder="Enter your password">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                                <span class="fa fa-key"></span>
                            </div>
                ...
                <div class="form-group mb-1">
                    <button id="signupButton" class="btn btn-block btn-primary" type="submit">Sign Up</button>
                </div>
                <div class="form-group text-center mb-0">
                    Have an account? <a class="text-underline" href="login.php">Login</a>
                </div>
            </form>
        </div>
    </div>
    ...
    if (isset($_SESSION['message']) && $_SESSION['message'] == "firstname") {
        ...
        echo '
                                ...
                                $(document).ready(function(){
                                    ...
                                    Toast.fire({
                                        icon: "error",
                                        title: "Incorrect first name format."
                                    });
                                });
